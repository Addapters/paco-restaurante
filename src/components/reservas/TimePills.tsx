...
import { LIMITE_RESERVAS_POR_HORARIO } from "@/lib/reservas/horario";
...
// simples, sem gestão real de capacidade por horário.
        ...
        {horarios.map((hora) => {
          ...
          return (
            <button
              ...
              className={cn(
                "rounded-full border py-2 text-sm font-medium transition-colors",
                cheio
